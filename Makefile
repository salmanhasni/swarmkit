...
GO_LDFLAGS_NONSTATIC=-ldflags "-X `go list ./version`.Version=$(VERSION)"
...
test: ## run tests, except integration tests
	@echo "🐳 $@"
	@go test -parallel 8 ${RACE} -tags "${DOCKER_BUILDTAGS}" ${GO_LDFLAGS} $(filter-out ${INTEGRATION_PACKAGE},${PACKAGES})
